...
parser.add_argument('data_path', type=str, help=('Path to the datasets. This should point to the location with `megadepth` and `imw2020-val` directories.'),)
parser.add_argument('--reward', choices=['epipolar', 'depth'], default='depth', help='Reward criterion to use')
...
parser.add_argument('--train-scene-limit', type=int, default=1000, help=('Different scenes in the dataset have a different amount of covisible image triplets. '
                                                                         'We (randomly) subselect --train-scene-limit of them for training, to avoid introducing a data bias towards those scenes.'))
parser.add_argument('--test-scene-limit', type=int, default=250, help=('Different scenes in the dataset have a different amount of covisible'
                                                                      ' image triplets. We (randomly) subselect --test-scene-limit of them for validation to avoid '
...
parser.add_argument('--epoch-offset', type=int, default=0, help=('Start counting epochs from this value. Influences the annealing '
                                                                'procedures, and is therefore useful when restarting from a checkpoint'),)
