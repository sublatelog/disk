...
class DISK(torch.nn.Module):
    def __init__(
        ...
        self.unet = Unet(
                        ...
                        setup=setup, # {**thin_setup, 'bias': True, 'padding': True}
                        )
    ...
    def features(
        ...
        # 'rng': keypoints = self.detector.sample(heatmaps, **kwargs)
        keypoints = {
