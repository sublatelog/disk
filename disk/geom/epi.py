...
def asymmdist(x1: [2, 'N'], x2: [2, 'M'], F: [3, 3]) -> ['N', 'M']:
    ...
    """
    dist
    tensor([[ 199.8541,  199.9102,  213.7471,  ...,  535.2107,  553.4301,
              565.1998],
            [ 139.3093,  139.6250,  153.2235,  ...,  587.8046,  607.4080,
              619.7399],
            [ 123.0942,  123.4774,  136.9827,  ...,  600.2960,  620.2189,
              632.6707],
            ...,
            [-420.1806, -419.1535, -431.8788,  ..., -236.3396, -246.0667,
             -253.7245],
            [-426.0595, -424.9988, -437.6277,  ..., -224.7359, -234.1198,
             -241.5981],
            [-434.6084, -433.4982, -445.9763,  ..., -207.2901, -216.1563,
             -223.3627]], device='cuda:0')
    """
    return dist.T
